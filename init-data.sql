-- Начальные данные для Resource Manager
-- Этот файл используется Flyway как миграция V6__init_data.sql
-- или может быть выполнен вручную после создания таблиц
...
-- Определения динамических колонок
